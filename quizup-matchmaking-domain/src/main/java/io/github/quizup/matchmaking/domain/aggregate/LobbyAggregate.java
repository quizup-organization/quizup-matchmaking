...
public class LobbyAggregate {
    ...
    /**
     * Purge un lobby fermé (après rétention, pilotée par la saga) : supprime l'agrégat
     * et son flux d'événements. La projection supprime sa ligne sur {@code LobbyPurgedEvent}.
     */
    @CommandHandler
