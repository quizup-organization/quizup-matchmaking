...
public class LobbyController {
    ...
    public CompletableFuture<ResponseEntity<Collection<NotificationEnvelope<LobbyNotification>>>> notifications(@PathVariable String lobbyId) {
        ...
        return getLobbyEventsUseCase.getEvents(lobbyId)
                .thenApply(envelopes -> envelopes.stream()
                        .map(envelope -> LobbyEventNotificationMapper.toNotification(envelope.payload())
